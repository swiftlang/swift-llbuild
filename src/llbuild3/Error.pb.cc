...
inline constexpr Error::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ...
        code_{::uint64_t{0u}},
        type_{static_cast< ::llbuild3::ErrorType >(0)} {}
...
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_llbuild3_2fError_2eproto[1];
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_llbuild3_2fError_2eproto = nullptr;
const ::uint32_t
    TableStruct_llbuild3_2fError_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        PROTOBUF_FIELD_OFFSET(::llbuild3::Error, _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(::llbuild3::Error, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::llbuild3::Error, _impl_.type_),
        PROTOBUF_FIELD_OFFSET(::llbuild3::Error, _impl_.code_),
        PROTOBUF_FIELD_OFFSET(::llbuild3::Error, _impl_.description_),
        PROTOBUF_FIELD_OFFSET(::llbuild3::Error, _impl_.context_),
        ~0u,
        1,
        0,
        ~0u,
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, 12, -1, sizeof(::llbuild3::Error)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::llbuild3::_Error_default_instance_._instance,
};
const char descriptor_table_protodef_llbuild3_2fError_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\024llbuild3/Error.proto\022\010llbuild3\032\031google"
    "/protobuf/any.proto\"\227\001\n\005Error\022!\n\004type\030\001 "
...
static ::absl::once_flag descriptor_table_llbuild3_2fError_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_llbuild3_2fError_2eproto = {
    ...
    descriptor_table_llbuild3_2fError_2eproto_deps,
    1,
    1,
    schemas,
    file_default_instances,
    TableStruct_llbuild3_2fError_2eproto::offsets,
    file_level_enum_descriptors_llbuild3_2fError_2eproto,
    file_level_service_descriptors_llbuild3_2fError_2eproto,
};
namespace llbuild3 {
const ::google::protobuf::EnumDescriptor* ErrorType_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_llbuild3_2fError_2eproto);
...
Error::Error(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:llbuild3.Error)
}
inline PROTOBUF_NDEBUG_INLINE Error::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::llbuild3::Error& from_msg)
...
Error::Error(
  ...
  // @@protoc_insertion_point(copy_constructor:llbuild3.Error)
}
inline PROTOBUF_NDEBUG_INLINE Error::Impl_::Impl_(
...
Error::~Error() {
  // @@protoc_insertion_point(destructor:llbuild3.Error)
...
const ::_pbi::TcParseTable<2, 4, 1, 34, 2> Error::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::llbuild3::Error>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:llbuild3.Error)
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
::uint8_t* Error::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:llbuild3.Error)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "llbuild3.Error.description");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:llbuild3.Error)
  return target;
}

::size_t Error::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:llbuild3.Error)
  ::size_t total_size = 0;
...
void Error::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:llbuild3.Error)
...
// @@protoc_insertion_point(class_specific_copy_from_start:llbuild3.Error)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_llbuild3_2fError_2eproto),
         ::std::false_type{});
