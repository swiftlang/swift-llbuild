...
public enum Llbuild3_Core_ArtifactType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Llbuild3_Core_ArtifactType] = [
    .file,
    .directory,
    .blob,
    .dict,
...
public struct Llbuild3_Core_DictObject: Sendable {
...
public struct Llbuild3_Core_ListObject: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Llbuild3_Core_Artifact: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var type: Llbuild3_Core_ArtifactType = .file

  public var value: Llbuild3_Core_Artifact.OneOf_Value? = nil
  ...
  public var dict: Llbuild3_Core_DictObject {
    get {
      if case .dict(let v)? = value {return v}
      return Llbuild3_Core_DictObject()
    }
    set {value = .dict(newValue)}
  }

  public var list: Llbuild3_Core_ListObject {
    get {
      if case .list(let v)? = value {return v}
      return Llbuild3_Core_ListObject()
    }
  ...
  public enum OneOf_Value: Equatable, @unchecked Sendable {
    ...
    case blob(Data)
    case dict(Llbuild3_Core_DictObject)
...
extension Llbuild3_Core_ArtifactType: SwiftProtobuf._ProtoNameProviding {
...
extension Llbuild3_Core_DictObject: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_DictObject, rhs: Llbuild3_Core_DictObject) -> Bool {
...
extension Llbuild3_Core_ListObject: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_ListObject, rhs: Llbuild3_Core_ListObject) -> Bool {
...
extension Llbuild3_Core_Artifact: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try {
        var v: Llbuild3_Core_DictObject?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
      ...
      case 6: try {
        var v: Llbuild3_Core_ListObject?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
  ...
  public static func ==(lhs: Llbuild3_Core_Artifact, rhs: Llbuild3_Core_Artifact) -> Bool {
