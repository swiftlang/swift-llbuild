...
public struct Llbuild3_Core_Signature: @unchecked Sendable {
...
public struct Llbuild3_Core_TaskResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var artifacts: [Llbuild3_Core_Artifact] = []
...
public struct Llbuild3_Core_ActionResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var actionResultValue: Llbuild3_Core_ActionResult.OneOf_ActionResultValue? = nil

  public var casObject: Llbuild3_Core_CASObjectID {
    get {
      if case .casObject(let v)? = actionResultValue {return v}
      return Llbuild3_Core_CASObjectID()
    }
  ...
  public enum OneOf_ActionResultValue: Equatable, Sendable {
    case casObject(Llbuild3_Core_CASObjectID)
...
public struct Llbuild3_Core_TaskInput: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var inputObject: Llbuild3_Core_TaskInput.OneOf_InputObject? = nil
  ...
  public var artifact: Llbuild3_Core_Artifact {
    get {
      if case .artifact(let v)? = inputObject {return v}
      return Llbuild3_Core_Artifact()
    }
    set {inputObject = .artifact(newValue)}
  }

  public var result: Llbuild3_Core_TaskResult {
    get {
      if case .result(let v)? = inputObject {return v}
      return Llbuild3_Core_TaskResult()
    }
    set {inputObject = .result(newValue)}
  }

  public var action: Llbuild3_Core_ActionResult {
    get {
      if case .action(let v)? = inputObject {return v}
      return Llbuild3_Core_ActionResult()
    }
  ...
  public enum OneOf_InputObject: Equatable, Sendable {
    ...
    case artifact(Llbuild3_Core_Artifact)
    case result(Llbuild3_Core_TaskResult)
    case action(Llbuild3_Core_ActionResult)
...
public struct Llbuild3_Core_TaskInputs: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var inputs: [Llbuild3_Core_TaskInput] = []
...
public struct Llbuild3_Core_TaskContext: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var taskState: Llbuild3_Core_TaskContext.OneOf_TaskState? = nil

  public var casState: Llbuild3_Core_CASObjectID {
    get {
  ...
  public enum OneOf_TaskState: Equatable, Sendable {
    case casState(Llbuild3_Core_CASObjectID)
...
public struct Llbuild3_Core_TaskWait: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var context: Llbuild3_Core_TaskContext {
    get {return _context ?? Llbuild3_Core_TaskContext()}
  ...
  fileprivate var _context: Llbuild3_Core_TaskContext? = nil
}

public struct Llbuild3_Core_TaskNextState: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var stateValue: Llbuild3_Core_TaskNextState.OneOf_StateValue? = nil

  public var wait: Llbuild3_Core_TaskWait {
    get {
      if case .wait(let v)? = stateValue {return v}
      return Llbuild3_Core_TaskWait()
    }
  ...
  public enum OneOf_StateValue: Equatable, Sendable {
    case wait(Llbuild3_Core_TaskWait)
    case result(Llbuild3_Core_TaskResult)
    case error(Llbuild3_Error)
...
extension Llbuild3_Core_Signature: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_Signature, rhs: Llbuild3_Core_Signature) -> Bool {
...
extension Llbuild3_Core_TaskResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_TaskResult, rhs: Llbuild3_Core_TaskResult) -> Bool {
...
extension Llbuild3_Core_ActionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Llbuild3_Core_CASObjectID?
  ...
  public static func ==(lhs: Llbuild3_Core_ActionResult, rhs: Llbuild3_Core_ActionResult) -> Bool {
...
extension Llbuild3_Core_TaskInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try {
        var v: Llbuild3_Core_TaskResult?
        var hadOneofValue = false
        if let current = self.inputObject {
          hadOneofValue = true
      ...
      case 5: try {
        var v: Llbuild3_Core_ActionResult?
        var hadOneofValue = false
        if let current = self.inputObject {
          hadOneofValue = true
  ...
  public static func ==(lhs: Llbuild3_Core_TaskInput, rhs: Llbuild3_Core_TaskInput) -> Bool {
...
extension Llbuild3_Core_TaskInputs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_TaskInputs, rhs: Llbuild3_Core_TaskInputs) -> Bool {
...
extension Llbuild3_Core_TaskContext: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_TaskContext, rhs: Llbuild3_Core_TaskContext) -> Bool {
...
extension Llbuild3_Core_TaskWait: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_TaskWait, rhs: Llbuild3_Core_TaskWait) -> Bool {
...
extension Llbuild3_Core_TaskNextState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_TaskNextState, rhs: Llbuild3_Core_TaskNextState) -> Bool {
