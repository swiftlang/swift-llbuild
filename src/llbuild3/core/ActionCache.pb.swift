...
public enum Llbuild3_Core_CacheKeyType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Llbuild3_Core_CacheKeyType] = [
    .task,
    .action,
  ]
...
public struct Llbuild3_Core_CacheKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var label: Llbuild3_Core_Label {
    get {return _label ?? Llbuild3_Core_Label()}
    set {_label = newValue}
  }
  ...
  public var type: Llbuild3_Core_CacheKeyType = .task

  public var content: Llbuild3_Core_CASObjectID {
    get {return _content ?? Llbuild3_Core_CASObjectID()}
  ...
  fileprivate var _label: Llbuild3_Core_Label? = nil
  fileprivate var _content: Llbuild3_Core_CASObjectID? = nil
}

public struct Llbuild3_Core_CacheValue: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var data: Llbuild3_Core_CASObjectID {
    get {return _data ?? Llbuild3_Core_CASObjectID()}
    set {_data = newValue}
  }
  ...
  public var stats: [Llbuild3_Core_ActionStat] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _data: Llbuild3_Core_CASObjectID? = nil
}

public struct Llbuild3_Core_ActionStat: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var value: Llbuild3_Core_ActionStat.OneOf_Value? = nil
...
extension Llbuild3_Core_CacheKeyType: SwiftProtobuf._ProtoNameProviding {
...
extension Llbuild3_Core_CacheKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_CacheKey, rhs: Llbuild3_Core_CacheKey) -> Bool {
...
extension Llbuild3_Core_CacheValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_CacheValue, rhs: Llbuild3_Core_CacheValue) -> Bool {
...
extension Llbuild3_Core_ActionStat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Core_ActionStat, rhs: Llbuild3_Core_ActionStat) -> Bool {
