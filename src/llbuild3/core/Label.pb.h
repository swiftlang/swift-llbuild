...
#ifndef GOOGLE_PROTOBUF_INCLUDED_llbuild3_2fcore_2fLabel_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_llbuild3_2fcore_2fLabel_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_llbuild3_2fcore_2fLabel_2eproto
...
struct TableStruct_llbuild3_2fcore_2fLabel_2eproto {
...
/* @@protoc_insertion_point(class_definition:llbuild3.core.Label) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "llbuild3.core.Label"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:llbuild3.core.Label)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_llbuild3_2fcore_2fLabel_2eproto;
};
...
inline std::string* Label::add_components()
  ...
  // @@protoc_insertion_point(field_add_mutable:llbuild3.core.Label.components)
  return _s;
}
inline const std::string& Label::components(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:llbuild3.core.Label.components)
  return _internal_components().Get(index);
}
inline std::string* Label::mutable_components(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:llbuild3.core.Label.components)
...
inline void Label::set_components(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:llbuild3.core.Label.components)
}
...
inline void Label::set_components(int index, const char* value) {
  ...
  _internal_mutable_components()->Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:llbuild3.core.Label.components)
}
inline void Label::set_components(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_components()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:llbuild3.core.Label.components)
}
inline void Label::set_components(int index, absl::string_view value) {
  _internal_mutable_components()->Mutable(index)->assign(
      value.data(), value.size());
  // @@protoc_insertion_point(field_set_string_piece:llbuild3.core.Label.components)
}
inline void Label::add_components(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_components()->Add()->assign(value);
  // @@protoc_insertion_point(field_add:llbuild3.core.Label.components)
}
...
inline const std::string& Label::name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:llbuild3.core.Label.name)
...
inline PROTOBUF_ALWAYS_INLINE void Label::set_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:llbuild3.core.Label.name)
}
inline std::string* Label::mutable_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:llbuild3.core.Label.name)
  return _s;
}
...
inline std::string* Label::release_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:llbuild3.core.Label.name)
...
inline void Label::set_allocated_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:llbuild3.core.Label.name)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_llbuild3_2fcore_2fLabel_2eproto_2epb_2eh
