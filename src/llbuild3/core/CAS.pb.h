...
#ifndef GOOGLE_PROTOBUF_INCLUDED_llbuild3_2fcore_2fCAS_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_llbuild3_2fcore_2fCAS_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_llbuild3_2fcore_2fCAS_2eproto
...
struct TableStruct_llbuild3_2fcore_2fCAS_2eproto {
...
/* @@protoc_insertion_point(class_definition:llbuild3.core.CASObjectID) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "llbuild3.core.CASObjectID"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:llbuild3.core.CASObjectID)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_llbuild3_2fcore_2fCAS_2eproto;
};
// -------------------------------------------------------------------

class CASObject final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:llbuild3.core.CASObject) */ {
 public:
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "llbuild3.core.CASObject"; }
 ...
 public:
  ...
  // repeated .llbuild3.core.CASObjectID refs = 1;
  int refs_size() const;
  private:
  ...
  public:
  void clear_refs() ;
  ::llbuild3::core::CASObjectID* mutable_refs(int index);
  ::google::protobuf::RepeatedPtrField<::llbuild3::core::CASObjectID>* mutable_refs();

  private:
  const ::google::protobuf::RepeatedPtrField<::llbuild3::core::CASObjectID>& _internal_refs() const;
  ::google::protobuf::RepeatedPtrField<::llbuild3::core::CASObjectID>* _internal_mutable_refs();
  public:
  const ::llbuild3::core::CASObjectID& refs(int index) const;
  ::llbuild3::core::CASObjectID* add_refs();
  const ::google::protobuf::RepeatedPtrField<::llbuild3::core::CASObjectID>& refs() const;
  // bytes data = 2;
  void clear_data() ;
  ...
  public:
  // @@protoc_insertion_point(class_scope:llbuild3.core.CASObject)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::llbuild3::core::CASObjectID > refs_;
...
inline const std::string& CASObjectID::bytes() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:llbuild3.core.CASObjectID.bytes)
...
inline PROTOBUF_ALWAYS_INLINE void CASObjectID::set_bytes(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:llbuild3.core.CASObjectID.bytes)
}
inline std::string* CASObjectID::mutable_bytes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_bytes();
  // @@protoc_insertion_point(field_mutable:llbuild3.core.CASObjectID.bytes)
  return _s;
}
...
inline std::string* CASObjectID::release_bytes() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:llbuild3.core.CASObjectID.bytes)
...
inline void CASObjectID::set_allocated_bytes(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:llbuild3.core.CASObjectID.bytes)
}
...
inline ::llbuild3::core::CASObjectID* CASObject::mutable_refs(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:llbuild3.core.CASObject.refs)
  return _internal_mutable_refs()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::llbuild3::core::CASObjectID>* CASObject::mutable_refs()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:llbuild3.core.CASObject.refs)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_refs();
}
inline const ::llbuild3::core::CASObjectID& CASObject::refs(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:llbuild3.core.CASObject.refs)
  return _internal_refs().Get(index);
}
inline ::llbuild3::core::CASObjectID* CASObject::add_refs() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::llbuild3::core::CASObjectID* _add = _internal_mutable_refs()->Add();
  // @@protoc_insertion_point(field_add:llbuild3.core.CASObject.refs)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::llbuild3::core::CASObjectID>& CASObject::refs() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:llbuild3.core.CASObject.refs)
  return _internal_refs();
}
inline const ::google::protobuf::RepeatedPtrField<::llbuild3::core::CASObjectID>&
CASObject::_internal_refs() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.refs_;
}
inline ::google::protobuf::RepeatedPtrField<::llbuild3::core::CASObjectID>*
...
inline const std::string& CASObject::data() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:llbuild3.core.CASObject.data)
...
inline PROTOBUF_ALWAYS_INLINE void CASObject::set_data(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:llbuild3.core.CASObject.data)
}
inline std::string* CASObject::mutable_data() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_data();
  // @@protoc_insertion_point(field_mutable:llbuild3.core.CASObject.data)
  return _s;
}
...
inline std::string* CASObject::release_data() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:llbuild3.core.CASObject.data)
...
inline void CASObject::set_allocated_data(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:llbuild3.core.CASObject.data)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_llbuild3_2fcore_2fCAS_2eproto_2epb_2eh
