...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_llbuild3_2fcore_2fCAS_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_llbuild3_2fcore_2fCAS_2eproto = nullptr;
const ::uint32_t
    TableStruct_llbuild3_2fcore_2fCAS_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::llbuild3::core::CASObjectID, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::llbuild3::core::CASObjectID, _impl_.bytes_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::llbuild3::core::CASObject, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::llbuild3::core::CASObject, _impl_.refs_),
        PROTOBUF_FIELD_OFFSET(::llbuild3::core::CASObject, _impl_.data_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::llbuild3::core::CASObjectID)},
        {9, -1, -1, sizeof(::llbuild3::core::CASObject)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::llbuild3::core::_CASObjectID_default_instance_._instance,
    &::llbuild3::core::_CASObject_default_instance_._instance,
};
const char descriptor_table_protodef_llbuild3_2fcore_2fCAS_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\027llbuild3/core/CAS.proto\022\rllbuild3.core"
    "\"\034\n\013CASObjectID\022\r\n\005bytes\030\001 \001(\014\"C\n\tCASObj"
    "ect\022(\n\004refs\030\001 \003(\0132\032.llbuild3.core.CASObj"
    "ectID\022\014\n\004data\030\002 \001(\014b\006proto3"
};
static ::absl::once_flag descriptor_table_llbuild3_2fcore_2fCAS_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_llbuild3_2fcore_2fCAS_2eproto = {
    false,
    false,
    147,
    descriptor_table_protodef_llbuild3_2fcore_2fCAS_2eproto,
    "llbuild3/core/CAS.proto",
    &descriptor_table_llbuild3_2fcore_2fCAS_2eproto_once,
    nullptr,
    0,
    2,
    schemas,
    file_default_instances,
    TableStruct_llbuild3_2fcore_2fCAS_2eproto::offsets,
    file_level_enum_descriptors_llbuild3_2fcore_2fCAS_2eproto,
    file_level_service_descriptors_llbuild3_2fcore_2fCAS_2eproto,
};
namespace llbuild3 {
namespace core {
// ===================================================================
...
CASObjectID::CASObjectID(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:llbuild3.core.CASObjectID)
}
inline PROTOBUF_NDEBUG_INLINE CASObjectID::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::llbuild3::core::CASObjectID& from_msg)
...
CASObjectID::CASObjectID(
  ...
  // @@protoc_insertion_point(copy_constructor:llbuild3.core.CASObjectID)
}
inline PROTOBUF_NDEBUG_INLINE CASObjectID::Impl_::Impl_(
...
CASObjectID::~CASObjectID() {
  // @@protoc_insertion_point(destructor:llbuild3.core.CASObjectID)
...
const ::_pbi::TcParseTable<0, 1, 0, 0, 2> CASObjectID::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::llbuild3::core::CASObjectID>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:llbuild3.core.CASObjectID)
...
::uint8_t* CASObjectID::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:llbuild3.core.CASObjectID)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:llbuild3.core.CASObjectID)
  return target;
}

::size_t CASObjectID::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:llbuild3.core.CASObjectID)
  ::size_t total_size = 0;
...
void CASObjectID::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:llbuild3.core.CASObjectID)
...
// @@protoc_insertion_point(class_specific_copy_from_start:llbuild3.core.CASObjectID)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
CASObject::CASObject(::google::protobuf::Arena* arena)
    : ::google::protobuf::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:llbuild3.core.CASObject)
}
inline PROTOBUF_NDEBUG_INLINE CASObject::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::llbuild3::core::CASObject& from_msg)
...
CASObject::CASObject(
  ...
  // @@protoc_insertion_point(copy_constructor:llbuild3.core.CASObject)
}
inline PROTOBUF_NDEBUG_INLINE CASObject::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
CASObject::~CASObject() {
  // @@protoc_insertion_point(destructor:llbuild3.core.CASObject)
  _internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  SharedDtor();
}
...
const ::_pbi::TcParseTable<1, 2, 1, 0, 2> CASObject::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::llbuild3::core::CASObject>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // bytes data = 2;
    {::_pbi::TcParser::FastBS1,
...
// @@protoc_insertion_point(message_clear_start:llbuild3.core.CASObject)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* CASObject::_InternalSerialize(
    ::uint8_t* target,
    ::google::protobuf::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:llbuild3.core.CASObject)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:llbuild3.core.CASObject)
  return target;
}

::size_t CASObject::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:llbuild3.core.CASObject)
  ::size_t total_size = 0;
...
void CASObject::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:llbuild3.core.CASObject)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:llbuild3.core.CASObject)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_llbuild3_2fcore_2fCAS_2eproto),
         ::std::false_type{});
