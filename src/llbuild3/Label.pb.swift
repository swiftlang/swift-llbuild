...
public struct Llbuild3_Label: Sendable {
...
extension Llbuild3_Label: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Llbuild3_Label, rhs: Llbuild3_Label) -> Bool {
